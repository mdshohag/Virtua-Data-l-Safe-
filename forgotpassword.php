...
<div class="row">
	<div class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-3">
		...
		<h1 class="text-center m-lg-top hidden-xs"><b>Forgot your password?</b><br>
		<span style="font-size:20px;">Enter your Email and we’ll help you reset your password.</span>
		</h1>
		<form role="form" class="forgotpassword" id="forgotpassword">
		<div class="text-box">
		...
		<button type="submit" class="button logInForm__login-button-container button--fluid button--action" id="login_button">Reset password</button>
		</form>
		</div>
		</div>
