						...
						<div class="panel-body">
							<div class="row">
								...
								<div class="tab-content">
									...
									<form class="form-horizontal" id="bank_update" method="post" enctype="multipart/form-data" >
									  ...
									  <!--<div class="form-group">
										<label for="inputUser" class="col-sm-3 control-label">Bank Account</label>
										<div class="col-sm-9">
										
										  <input class="form-control" name="bank_account" type="text" value="<//?php echo $bank_data['bank_account']; ?>" id="bank_account" >
										</div>
									  </div>-->
