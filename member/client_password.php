...
$client_id = $_SESSION['customer_id'];
 $user_data_id = $cls_virtual_safe_client->client_user_data($client_id);
						...
						<div class="panel-body">
							<div class="row">
								<div class="col-md-10 col-md-offset-1">
									<form class="form-horizontal" id="client_password" method="post" enctype="multipart/form-data" >
									 
									  
									  <div class="form-group">
										<label for="inputUser" class="col-sm-3 control-label">Old Password</label>
										<div class="col-sm-9">
										<input type="hidden" value="<?php echo $client_id; ?>" name="userdataid">
