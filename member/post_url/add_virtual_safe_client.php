					...
					'<tr>'.
					   ' <td valign="top">'.
                        ...
                        '<tr>'.
							...
							'<p style="font-size:19px;font-weight:normal;line-height:22px;margin:0 0 11px 0">'.'Your user ID is: '.$email.''.'</p>'.
...
$headers .= "Content-Type: text/html; charset=UTF-8\r\n"; 
 ...
 echo $cls_virtual_safe_client->vs_registration($vs_id,$first_name,$last_name,$agentid,$email,$address,$vs_code,$password);
