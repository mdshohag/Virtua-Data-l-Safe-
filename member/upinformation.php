<?php include('include/header.php'); 
	...
	$tvs_data_id = $cls_virtual_safe_client->information_user_data($user_id,$client_id);
						...
						<div class="panel-body">
							<div class="row">
								...
								<div class="tab-content">
									...
									<form class="form-horizontal" id="information_update" method="post" enctype="multipart/form-data" >
