...
$request =  json_encode($createTransactionRequest);
   ...
   $headers = array("Content-Type:application/json",
		...
		if(isset($response->messages->resultCode) && $response->messages->resultCode=='Ok' )
		{
				...
				if(isset($response->messages->message[0]->code) && $response->messages->message[0]->code=='I00001')
				{
					...
					if(isset($response->transactionResponse->transId) && $response->transactionResponse->transId > 0)
					{
						...
						echo("<script>location.href = 'http://localhost/benefits_hts/member/agent_successlifetime.php?client=$clint_id&&amount=$x_amount';</script>");
					}
					else
					{
					//echo"not";
	...
	echo "no";
		//http://localhost/benefits_hts/member/cancel.php
...
$view_amount_lifetime = $cls_payment_type->view_payment_lifetime_amount();
$amount = $view_amount_lifetime->fetch_assoc();
$lifetime = $amount['amount_fees'];
								...
								<div class="payment">
									...
									<div class="row">
										...
										<div class="input-group">
											<input type="hidden" id="x_amount" name="x_amount" value="<?php echo $lifetime; ?>">
									...
									<div class="row">
										...
										<div class="col-xs-6 pull-right">
											<div class="form-group">
												...
												<input class="form-control" value="$<?php echo $lifetime; ?>" readonly />
											</div>
										</div>
									</div>
									</form>	
