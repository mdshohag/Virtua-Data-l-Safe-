...
<div class="row">
	...
	<div style=" margin-left:40px;margin-right:40px;">
		<form role="form" class="up-form" id="uppasswd"><br></br>
		...
		<h1 class="vv-lg-top hidden-xs">Please Create New Password to Continue with The Virtual Safe Registration</h1>
			...
			<div class="form-group">
				<input type="password" name="old_password" id="old_password" class="form-control input-lg" placeholder="Temporary Password">
