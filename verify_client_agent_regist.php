...
<div class="row">
	...
	<div style=" margin-left:40px;margin-right:40px;">
		<form role="form" class="up-form" id="verify_client"><br></br>
		...
		<h1 class="vv-lg-top hidden-xs">Please Create New Password to Continue with The Virtual Safe Registration</h1>
			...
			<div class="form-group">
				<input type="email" name="user_id" id="user_id" class="form-control input-lg" placeholder="User ID">
				
			</div>
			<div class="form-group">
				<input type="password" name="password" id="password" class="form-control input-lg" placeholder="New Password">
				<input type="hidden" value="<?php echo $uid; ?>" name="userdataid">
			</div>
			<div class="form-group">
