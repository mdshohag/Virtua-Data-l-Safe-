				...
				<div class="container-fluid">
					...
					<div class="panel panel-headline">
						<div class="panel-heading">
							<h3 class="panel-title"><center>Deactivated Insurance Agent</center></h3>
							...
							<div class="row">
							 ...
							 <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
									<?php
									$i = 1;
										while($view_data = $view_insurance_agent_deactivated->fetch_assoc()){
									?>
									<tr>
										<td><?php echo $i++; ?></td>
										...
										<td>
										<button agent_active="<?php echo $view_data['agent_id']; ?>" class="btn btn-primary btn-sm agent_active">Activated  </button> <br>
