				...
				<div class="container-fluid">
					...
					<div class="panel panel-headline">
						...
						<center><h3 class="panel-title">Welcome to The Virtual Safe</h3></center>
							<h3 class="panel-title">All List Virtual Safe Client</h3>
						...
						<div class="panel-body">
							<div class="row">
                                ...
                                <tbody>
									<?php
									$i= 1;
										while($view_data = $view_vs_client_id->fetch_assoc()){
									?>
									<tr>
										...
										<!--<button tvs_id="<//?php echo $view_data['client_id']; ?>" class="btn btn-primary btn-xs tvs_id">&nbsp;Deactivated  &nbsp;</button> 
										<br>-->
