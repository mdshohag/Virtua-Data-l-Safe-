...
$db = new mysqli("localhost", "root", "", "db_benefit");	
		...
		$amount_dolors = $db->query("SELECT * From tbl_payment_fees where type='company'");
...
foreach($objPHPExcel->getWorksheetIterator() as $worksheet)
{
	...
	//	$html.="<tr>";
		...
		$sql = "INSERT INTO tbl_vs_client(client_id,client_first_name,client_last_name,client_email,vs_code,subscription_rcbl,company_client,company_id,client_password,active)VALUES('$vs_id','$first_name','$last_name','$email','$vs_code','$annualss','Y','$company_code',md5('$passwd'),'1')";
