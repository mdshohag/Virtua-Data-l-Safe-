<?php
	...
	$paytrack_id = "$_POST[paytrack_id]";
	
	
	
	
	echo $cls_company_paytrack->update_company_paytrack($companyid,$company_roster_id,$pay_month,$pay_year,$pay_date,$pay_status,$paytrack_id);
