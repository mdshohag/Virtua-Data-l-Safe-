				...
				<div class="container-fluid">
					...
					<div class="panel panel-headline">
						<div class="panel-heading">
							<h3 class="panel-title"><center>LifeTime Individual Client List</center></h3>
							<div class="panel-subtitle">
								 <span class="right"> <a href="lifetime_individual_report_print.php" target="_blank" class="btn btn-danger">PRINT</a> </span>
							</div>
						</div>
						<div class="panel-body">
							<div class="row">
								...
								<table>
									...
									<tr>
									<td><a href="lifetime_individual_report.php" class="btn btn-primary">LifeTime Individual Report </a></td>
									</tr>
