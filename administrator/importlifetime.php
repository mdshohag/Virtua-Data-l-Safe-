...
$sql = "INSERT INTO tbl_vs_client(client_id,client_first_name,client_last_name,client_email,vs_code,subscription_rcbl,	lifetime_pay,valid_from,valid_to,company_client,company_id,client_password,status)VALUES('". $vs_id ."','". $fname ."','". $lname ."','". $email . "','". $vs_code ."','". $annualss ."','".$lifetimepay."','". $todate ."','". $addoneyeardate ."','Y','". $company_code ."',md5('". $password ."'),'Lifetime')";
...
window.location = \"add_virtual_safe_lifetime.php\"
</script>";
}else{
