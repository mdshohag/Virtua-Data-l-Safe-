		...
		<div class="container-fluid">
			...
			<div class="panel panel-headline">
				<div class="panel-heading">
					<h3 class="panel-title">Add Virtual Safe benefit For Company (Pay <span style="color:red"><b>Life Time</b></span> Registration Fees)</h3>
					<p class="panel-subtitle"></p>
				</div>
				<div class="panel-body">
					<div class="row">
						<div class="col-md-10 col-md-offset-1">
							<form class="form-horizontal" action="importlifetime.php" method="post" name="upload_excel" enctype="multipart/form-data">
