...
$show_tvsc = $cls_insurance_agent->agent_view_tvsc_annual($agent);
					...
					<div class="panel panel-headline">
						<div class="panel-heading">
							...
							<div class="panel-subtitle">
								  ...
								  <span class="right"> <a href="agent_view_client_print.php?agent_id=<?php echo $agent; ?>" target="_blank" class="btn btn-danger">PRINT</a> </span>
							</div>
						</div>
