				...
				<div class="container-fluid">
					...
					<div class="panel panel-headline">
						<div class="panel-heading">
							<h3 class="panel-title"><center>All Individual Client List</center></h3>
							<div class="panel-subtitle">
								 <span class="right"> <a href="individual_report_print.php" target="_blank" class="btn btn-danger">PRINT</a> </span>
							</div>
						</div>
							 ...
							 <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
									<?php
										...
										$view_individual = $cls_virtual_safe_client->all_individual_client_report();
