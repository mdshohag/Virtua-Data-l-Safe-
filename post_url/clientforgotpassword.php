<?php
	...
	$client = $cls_virtual_safe_client->forgotpasswordclient($email);
		
	$row = $client->fetch_assoc();
	
	$verify_id = $row['client_id'];
					   ...
					   ' <td valign="top">'.
                        ...
                        '<tr>'.
                            '<td valign="top">'.
								...
								'<a style="font-size:20px;" href="https://thevirtualsafe.com/demo/resetpasswordclient.php?id_code='.$verify_id.'" target="_blank" >'.
							'"Click Here"'.
							'</a>'.
							' '.'</p>'.
